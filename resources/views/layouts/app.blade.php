...
<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{asset('/frontend/img/logo.png')}}" width="95"
             alt="InfyOm Logo" style="    margin-top: -15px;
">
        <img class="navbar-brand-minimized" src="{{asset('frontend/img/logo.png')}}"
             width="50" alt="Infyom Logo">
    </a>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" style="margin-right: 10px;margin-top: -10px;" data-toggle="dropdown" href="#" role="button"
               aria-haspopup="true" aria-expanded="false">
                <img src="{{ asset('images/7.png') }}" class="img-avatar" alt="{!! Auth::user()->name !!}">
            </a>
...
<footer class="app-footer">
    <div style="color: #eb1a89">
        <span>&copy; {{date('Y')}} Yoga Magazine</span>
    </div>
    <div class="ml-auto">
        <span>Powered by</span>
        <a href="https://yogamagazine.com/">YogaMagazine</a>
    </div>
</footer>
</body>
<!-- jQuery 3.1.1 -->
